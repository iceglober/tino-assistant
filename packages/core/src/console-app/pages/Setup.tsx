...
import { useSaveState, SaveButton } from '../components/SaveButton.js';
    ...
    <div className="page">
      ...
      {step === 1 ? (
        <div className="setup-screen">
          <div className="setup-steps" aria-label="Setup progress: step 1 of 3">
          ...
          <div className="field-group">
            ...
            <div className={`field-error${botErr ? ' visible' : ''}`} id="slack-bot-token-error" role="alert" aria-live="polite">
              {botErr}
            </div>
          </div>
          ...
          <div className="field-group">
            ...
            <div className={`field-error${appErr ? ' visible' : ''}`} id="slack-app-token-error" role="alert" aria-live="polite">
              {appErr}
            </div>
          </div>
          ...
          <div className="help-block">
            ...
            <ol className="step-list" style={{ marginTop: 8 }}>
              <li>
                ...
                <span>Go to <a href="https://api.slack.com/apps" target="_blank" rel="noopener noreferrer">api.slack.com/apps</a> and open your app</span>
              </li>
              <li>
              ...
              <li>
                ...
                <span>Basic Information → App-Level Tokens → create one with <code>connections:write</code></span>
              </li>
            </ol>
          </div>
        </div>
        ...
        <div className="setup-screen">
          <div className="setup-steps" aria-label="Setup progress: step 2 of 3">
          ...
          <div className="field-group">
            <label className="field-label" htmlFor="bedrock-model-id">Bedrock Model ID</label>
            <input
              id="bedrock-model-id"
            ...
            <div className={`field-error${modelErr ? ' visible' : ''}`} id="bedrock-model-error" role="alert" aria-live="polite">
              {modelErr}
            </div>
          </div>

          <div className="field-group">
            <label className="field-label" htmlFor="admin-user-id">Your Slack User ID</label>
            <input
              id="admin-user-id"
              className="field-input"
              type="text"
            ...
            <div className={`field-error${adminErr ? ' visible' : ''}`} id="admin-user-error" role="alert" aria-live="polite">
              {adminErr}
            </div>
          </div>
