...
type SearchIssuesResult = { issues: IssueResult[]; count: number } | { error: string; message: string };
...
export async function _executeGetIssue(client: LinearClient, input: GetIssueInput): Promise<GetIssueResult> {
  try {
...
type CreateIssueResult = { issue: IssueResult } | { error: string; message: string };

export async function _executeCreateIssue(client: LinearClient, input: CreateIssueInput): Promise<CreateIssueResult> {
  try {
...
type UpdateIssueResult = { issue: IssueResult } | { error: string; message: string };

export async function _executeUpdateIssue(client: LinearClient, input: UpdateIssueInput): Promise<UpdateIssueResult> {
  try {
...
type AddCommentResult = { commentId: string; success: boolean } | { error: string; message: string };

export async function _executeAddComment(client: LinearClient, input: AddCommentInput): Promise<AddCommentResult> {
  try {
...
type ListMyIssuesResult = { issues: IssueResult[]; count: number } | { error: string; message: string };
