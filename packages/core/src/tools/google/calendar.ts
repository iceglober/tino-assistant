...
const inputSchema = z.object({
  ...
  timeMinIso: z
    .string()
    .min(1)
    .describe('ISO-8601 start of the time range, e.g. "2026-05-13T00:00:00-05:00"'),
  timeMaxIso: z
    .string()
    .min(1)
    .describe('ISO-8601 end of the time range, e.g. "2026-05-14T00:00:00-05:00"'),
  maxResults: z
    .number()
    .int()
    .min(1)
...
type CalendarResult =
  | { events: NormalizedEvent[]; count: number }
